  ...
  return (
    <Routes>
      <Route path="/" element={<Layout language={"es"} />}>
        ...
        <Route
          path="experiencia"
          element={<Experience language={es.categories} />}
        />
        <Route
          path="experiencia/:category"
          element={<Category categories={es.categories.categories} />}
        />
      ...
      <Route path="/en" element={<Layout language={"en"} />}>
        ...
        <Route
          path="experience"
          element={<Experience language={en.categories} />}
        />
        <Route
          path="experience/:category"
          element={<Category categories={en.categories.categories} />}
        />
        <Route path="about-us">
