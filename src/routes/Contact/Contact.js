...
export default function Contact({language}){
	...
	return(
		<div className="body">
			<ImageFrame src="/assets/images/banner4.jpg" h1={language.h1} h2={language.h2}/>
			<div className="content">
				...
				<div className="contact-section">
					...
					<div className="secondary-form-section">
						...
						<ul>
							<li><b>{language.other_phone}:</b> (+598) 2408 8931</li>
							<li><b>{language.other_mail}:</b> info@adapta.uy</li>
							<li><b>{language.other_address}:</b> Bv. Artigas 1443 OF 912, CP 11.200; Montevideo, Uruguay</li>
						</ul>
						<Map/>
					</div>
				</div>
