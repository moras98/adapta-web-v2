    ...
    return(
        <div className="mobile-navbar">
            <div className="mobile-navbar-elements">
                ...
                <div className="mobile-navbar-button" onClick={toggleMenu}>☰</div>
            </div>
            <div className={menuOpen ? "mobile-menu-open" : "mobile-menu-closed"}>
				{language === 'es' ? <MobileEsNav closeMenu={closeMenu}/> : <MobileEnNav closeMenu={closeMenu}/>}
			</div>
        </div>
    );
}
...
function MobileEsNav({closeMenu}){
    ...
    return(
        <ul className="mobile-nav-ul">
			...
			<li><LanguageSelector language={'es'} onClick={closeMenu}/></li>
        </ul>
    );
}
...
function MobileEnNav({closeMenu}){
    ...
    return(
        <ul className="mobile-nav-ul">
			...
			<li><LanguageSelector language={'en'} onClick={closeMenu}/></li>
        </ul>
    );
}